  ...
  return (
    ...
    <button
        ...
        style={{
          ...
          gap: '0.4rem',
          padding: '0.5rem 1rem',
  background: currentView === 'history' ? 'linear-gradient(135deg, var(--accent-bg), var(--accent-bg-2))' : 'transparent',
  ...
  border: currentView === 'history' ? '1px solid color-mix(in oklab, var(--accent-600), transparent 55%)' : '1px solid var(--border)',
    ...
    <button
        ...
        style={{
          ...
          gap: '0.4rem',
          padding: '0.5rem 1rem',
  background: currentView === 'stats' ? 'linear-gradient(135deg, var(--accent-bg), var(--accent-bg-2))' : 'transparent',
  ...
  border: currentView === 'stats' ? '1px solid color-mix(in oklab, var(--accent-600), transparent 55%)' : '1px solid var(--border)',
    ...
    <button
        ...
        style={{
          ...
          gap: '0.4rem',
          padding: '0.5rem 1rem',
  background: currentView === 'achievements' ? 'linear-gradient(135deg, var(--accent-bg), var(--accent-bg-2))' : 'transparent',
